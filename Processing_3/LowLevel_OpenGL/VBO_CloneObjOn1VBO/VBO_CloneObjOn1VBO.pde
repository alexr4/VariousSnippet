//From processing forum by codeantitcode (Andres Colubri)
...
void draw() {
  surface.setTitle("FPS : "+floor(frameRate)+" Nb cube : "+(nbObj*nbObj)+" Nb particles : "+nvert+" per cube"+" Nb total of Particles : "+((nbObj*nbObj)*nvert));
  background(0);
