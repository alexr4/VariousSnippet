...
void readVerticeArray()
{
  ...
  for (int i =0; i<cols-1; i++)
  {
    for (int j=0; j<rows-1; j++)
    {
      ...
      nV2.normalize();
      nV3.normalize();
      float r0 = map(nV0.x, 0, 1, 0, 255);
      float g0 = map(nV0.y, 0, 1, 0, 255);
      float b0 = map(nV0.z, 0, 1, 0, 255);

      float r1 = map(nV1.x, 0, 1, 0, 255);
      float g1 = map(nV1.y, 0, 1, 0, 255);
      float b1 = map(nV1.z, 0, 1, 0, 255);

      float r2 = map(nV2.x, 0, 1, 0, 255);
      float g2 = map(nV2.y, 0, 1, 0, 255);
      float b2 = map(nV2.z, 0, 1, 0, 255);

      float r3 = map(nV3.x, 0, 1, 0, 255);
      float g3 = map(nV3.y, 0, 1, 0, 255);
      float b3 = map(nV3.z, 0, 1, 0, 255);
